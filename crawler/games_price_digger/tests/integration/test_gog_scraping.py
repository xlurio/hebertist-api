...
from games_price_digger.spiders.gog_price import GogPriceSpider
...
class GogPriceTests(unittest.TestCase):
    test_game_name = 'Detective Gallo'
    store = 'GOG.com'

    def setUp(self) -> None:
        html_getter = TestHTMLGetter()
        html_path = html_getter.get_html_file_by_name('gog_test.html')
    ...
    def then_it_should_yield_game_data(self, parsed_data):
        ...
        expected_domain = 'www.gog.com'
        expected_route = '/en/game/detective_gallo'
        expected_parameters = ''
        expected_url = (
